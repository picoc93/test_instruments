...
class GWInstek (instrument.Instrument):
  ...
  #Select the number of record length. This scope provides record length of 500, 1250, 2500, 5000, 12500, 25000, 50000, and 125000.
  ...
  #Transfer the displayed waveform data (always 500 points data totally) from the scope. Each point is composed by two bytes (the integer value of 16 bits). The high byte (MSD) will be prior transferred.
  #<X>→Specify the channel number (1|2)
  ...
  #Select the different coupling states for the scope.
  #<X>→Specify the channel number (1|2)
